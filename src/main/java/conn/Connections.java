...
//		config.addDataSourceProperty("cloudSqlInstance", "striking-decker-288210:europe-west1:fishlistmysql");
	...
	public static Connection getDevConnection() throws Exception{
		...
		config.setJdbcUrl("jdbc:mysql://localhost:3306/"+System.getProperty("localdatabasename")); // see appengine-web.xml
